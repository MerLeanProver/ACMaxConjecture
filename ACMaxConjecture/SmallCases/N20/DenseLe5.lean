...
This file ports the induced-`C₅` shared-hub machinery of `TwinCert20Dense` to a hub of degree `4`
*or* `5`, as required by the `e(M) = 5`, `|Hub| = 6` corner of `n = 18` (where the degree-`4`
shared-hub pigeonhole only ties).

* `dense_two_twin_assemble_le5_twenty` — bundle a deg-`≤ 5` hub with two twins and an avoided
  cherry into a `TwoTwinConfig` (moved here from `TwinCert20TwoHubHub6Deg5`).
* `hub_meets_cycle_dist2_le5_twenty` — a deg-`≤ 5` hub cannot meet two cycle vertices at
  cycle-distance `2` *unless* it also meets the vertex between them (else an induced `C₄` of degree
  sum `≤ 14`, excluded by `hC4`).
* `hub_cycle_cases_le5_twenty` — from the five distance-`2` constraints, either the hub avoids a
  consecutive triple of the cycle (a cherry) or it hits a consecutive triple.
* `c5_shared_two_twin_le5_twenty` — wraps the cases: the cherry branch assembles a
...
theorem dense_two_twin_assemble_le5_twenty (G : SimpleGraph (Fin 20)) (t₁ t₂ h x y z : Fin 20)
...
theorem hub_meets_cycle_dist2_le5_twenty (G : SimpleGraph (Fin 20))
    (hC4 : ¬∃ a b c d : Fin 20, ({a, b, c, d} : Finset (Fin 20)).card = 4 ∧
      G.Adj a b ∧ G.Adj b c ∧ G.Adj c d ∧ G.Adj d a ∧ ¬G.Adj a c ∧ ¬G.Adj b d ∧
      G.degree a + G.degree b + G.degree c + G.degree d ≤ 14)
    {h x y z : Fin 20} (hhge4 : 4 ≤ G.degree h) (hhle5 : G.degree h ≤ 5)
...
(`hub_meets_cycle_dist2_le5_twenty`) rule out every other pattern. -/
theorem hub_cycle_cases_le5_twenty (G : SimpleGraph (Fin 20))
    (hC4 : ¬∃ a b c d : Fin 20, ({a, b, c, d} : Finset (Fin 20)).card = 4 ∧
      G.Adj a b ∧ G.Adj b c ∧ G.Adj c d ∧ G.Adj d a ∧ ¬G.Adj a c ∧ ¬G.Adj b d ∧
      G.degree a + G.degree b + G.degree c + G.degree d ≤ 14)
    (h v₁ v₂ v₃ v₄ v₅ : Fin 20) (hhge4 : 4 ≤ G.degree h) (hhle5 : G.degree h ≤ 5)
  ...
  have C234 := hub_meets_cycle_dist2_le5_twenty G hC4 hhge4 hhle5 hd2 hd3 hd4 e23 e36 n24
    d23 d36 d24
  have C345 := hub_meets_cycle_dist2_le5_twenty G hC4 hhge4 hhle5 hd3 hd4 hd5 e36 e45 n35
    d36 d45 d35
  have C451 := hub_meets_cycle_dist2_le5_twenty G hC4 hhge4 hhle5 hd4 hd5 hd1 e45 e51
    (fun a => n14 a.symm) d45 d15.symm d14.symm
  have C512 := hub_meets_cycle_dist2_le5_twenty G hC4 hhge4 hhle5 hd5 hd1 hd2 e51 e12
    (fun a => n25 a.symm) d15.symm d12 d25.symm
  have C123 := hub_meets_cycle_dist2_le5_twenty G hC4 hhge4 hhle5 hd1 hd2 hd3 e12 e23 n13
    d12 d23 d13
...
vertex `a`). -/
theorem hub_not_adj_deg3_two_deg3_nbrs (G : SimpleGraph (Fin 20)) (h k a x y : Fin 20)
  ...
  have hsub : ({x, y, k, h} : Finset (Fin 20)) ⊆ G.neighborFinset a := by
    intro w hw
  ...
  have hcard : ({x, y, k, h} : Finset (Fin 20)).card = 4 := by
...
(`hub_cycle_cases_le5_twenty`), `k` itself anchors the cut.  When `k` *hits* three consecutive
...
theorem c5_shared_two_twin_le5_twenty (G : SimpleGraph (Fin 20))
    ...
    (ht1iso : ∀ w : Fin 20, G.Adj t₁ w → G.degree w ≠ 3)
    (ht2iso : ∀ w : Fin 20, G.Adj t₂ w → G.degree w ≠ 3)
    (hnonk : ∀ a b c : Fin 20, G.degree a = 3 → G.degree b = 3 → G.degree c = 3 →
  ...
  have hB := hub_cycle_cases_le5_twenty G hC4 k v₁ v₂ v₃ v₄ v₅ hkge4 hkle5 hd1 hd2 hd3 hd4 hd5
  ...
  · exact dense_two_twin_assemble_le5_twenty G t₁ t₂ k v₁ v₂ v₃ ht1deg ht2deg hkge4 hkle5
      hd1 hd2 hd3 hAt1k hAt2k e12 e23 ht1iso ht2iso p1 p2 p3 ht12 d12 d23 d13
  · exact dense_two_twin_assemble_le5_twenty G t₁ t₂ k v₂ v₃ v₄ ht1deg ht2deg hkge4 hkle5
      hd2 hd3 hd4 hAt1k hAt2k e23 e36 ht1iso ht2iso p2 p3 p4 ht12 d23 d36 d24
  · exact dense_two_twin_assemble_le5_twenty G t₁ t₂ k v₃ v₄ v₅ ht1deg ht2deg hkge4 hkle5
      hd3 hd4 hd5 hAt1k hAt2k e36 e45 ht1iso ht2iso p3 p4 p5 ht12 d36 d45 d35
  · exact dense_two_twin_assemble_le5_twenty G t₁ t₂ k v₄ v₅ v₁ ht1deg ht2deg hkge4 hkle5
  ...
  · -- **Deg-`5` hub `k` adjacent to three *consecutive* `C₅` vertices.**  Here `k` hits the cherry
    ...
    -- `dense_two_twin_assemble_le5_twenty` closes.
    ...
    · obtain ⟨h, s₁, s₂, hhk, hh4, hh5, hs12, hs1d, hs2d, hAs1, hAs2, hs1iso, hs2iso⟩ :=
      ...
      have nh3 := hub_not_adj_deg3_two_deg3_nbrs G h k v₃ v₂ v₄ hhk.symm hkge4 hh4 e23.symm e36
        ha3.symm hd3 hd2 hd4 d24
      exact dense_two_twin_assemble_le5_twenty G s₁ s₂ h v₁ v₂ v₃ hs1d hs2d hh4 hh5
        hd1 hd2 hd3 hAs1 hAs2 e12 e23 hs1iso hs2iso nh1 nh2 nh3 hs12 d12 d23 d13
    · obtain ⟨h, s₁, s₂, hhk, hh4, hh5, hs12, hs1d, hs2d, hAs1, hAs2, hs1iso, hs2iso⟩ :=
        hnonk v₂ v₃ v₄ hd2 hd3 hd4 ha2 ha3 ha4 e23 e36 d23 d36 d24
      have nh2 := hub_not_adj_deg3_two_deg3_nbrs G h k v₂ v₁ v₃ hhk.symm hkge4 hh4 e12.symm e23
        ha2.symm hd2 hd1 hd3 d13
      have nh3 := hub_not_adj_deg3_two_deg3_nbrs G h k v₃ v₂ v₄ hhk.symm hkge4 hh4 e23.symm e36
        ha3.symm hd3 hd2 hd4 d24
      have nh4 := hub_not_adj_deg3_two_deg3_nbrs G h k v₄ v₃ v₅ hhk.symm hkge4 hh4 e36.symm e45
        ha4.symm hd4 hd3 hd5 d35
      exact dense_two_twin_assemble_le5_twenty G s₁ s₂ h v₂ v₃ v₄ hs1d hs2d hh4 hh5
        hd2 hd3 hd4 hAs1 hAs2 e23 e36 hs1iso hs2iso nh2 nh3 nh4 hs12 d23 d36 d24
    · obtain ⟨h, s₁, s₂, hhk, hh4, hh5, hs12, hs1d, hs2d, hAs1, hAs2, hs1iso, hs2iso⟩ :=
        hnonk v₃ v₄ v₅ hd3 hd4 hd5 ha3 ha4 ha5 e36 e45 d36 d45 d35
      have nh3 := hub_not_adj_deg3_two_deg3_nbrs G h k v₃ v₂ v₄ hhk.symm hkge4 hh4 e23.symm e36
        ha3.symm hd3 hd2 hd4 d24
      have nh4 := hub_not_adj_deg3_two_deg3_nbrs G h k v₄ v₃ v₅ hhk.symm hkge4 hh4 e36.symm e45
        ha4.symm hd4 hd3 hd5 d35
      ...
      exact dense_two_twin_assemble_le5_twenty G s₁ s₂ h v₃ v₄ v₅ hs1d hs2d hh4 hh5
        hd3 hd4 hd5 hAs1 hAs2 e36 e45 hs1iso hs2iso nh3 nh4 nh5 hs12 d36 d45 d35
    · obtain ⟨h, s₁, s₂, hhk, hh4, hh5, hs12, hs1d, hs2d, hAs1, hAs2, hs1iso, hs2iso⟩ :=
