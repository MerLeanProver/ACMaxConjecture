...
/-! # The blocker upper bound for the (10,8,42) octahedron corner (`n = 20`) -/
namespace ACMax
...
theorem rich_le_five_blocked_1042_twenty (G : SimpleGraph (Fin 20)) (Hub Iso : Finset (Fin 20))
    ...
    (_hHub : Hub.card = 10) (_hIso : Iso.card = 8) (_hdsum : ∑ w ∈ Hub, G.degree w = 42)
