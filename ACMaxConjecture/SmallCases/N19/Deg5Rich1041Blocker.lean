...
/-! # The blocker upper bound for the (10,7,41) octahedron corner (`n = 19`) -/
namespace ACMax
...
overlaps (`z` meets exactly `2` hubs by `zfacts_deg5_nineteen`). -/
theorem rich_le_five_blocked_1041_nineteen (G : SimpleGraph (Fin 19)) (Hub Iso : Finset (Fin 19))
    ...
    (_hHub : Hub.card = 10) (_hIso : Iso.card = 7) (_hdsum : ∑ w ∈ Hub, G.degree w = 41)
    ...
    (_hno2hub : ¬∃ h₁ h₂ : Fin 19, h₁ ∈ Hub ∧ h₂ ∈ Hub ∧
      ...
      2 ≤ ((G.neighborFinset h₂ ∩ Iso) \ G.neighborFinset h₁).card)
    (g : Fin 19) (_hg : g ∈ Hub) (_hgd : G.degree g = 4)
