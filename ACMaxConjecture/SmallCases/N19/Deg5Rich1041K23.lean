...
/-!
# The high-share K₂,₃ kill for the (10,7,41) octahedron corner (`n = 19`)
...
theorem highshare_k23_1041_nineteen (G : SimpleGraph (Fin 19)) (Iso : Finset (Fin 19))
    (hK23 : ¬∃ a b c d e : Fin 19, ({a, b, c, d, e} : Finset (Fin 19)).card = 5 ∧
      G.Adj a c ∧ G.Adj a d ∧ G.Adj a e ∧ G.Adj b c ∧ G.Adj b d ∧ G.Adj b e ∧
      ¬G.Adj a b ∧ ¬G.Adj c d ∧ ¬G.Adj c e ∧ ¬G.Adj d e ∧
      G.degree a + G.degree b + G.degree c + G.degree d + G.degree e ≤ 19)
    (hisoHub : ∀ t ∈ Iso, ∀ w : Fin 19, G.Adj t w → w ∉ Iso)
    (hisodeg3 : ∀ t ∈ Iso, G.degree t = 3)
    (x f : Fin 19) (hxd : G.degree x = 4) (hfd : G.degree f = 5)
    (hnadj : ¬G.Adj x f)
  ...
  have hmem : ∀ w ∈ ({c, d, e} : Finset (Fin 19)),
  ...
  have hcard5 : ({x, f, c, d, e} : Finset (Fin 19)).card = 5 := by
