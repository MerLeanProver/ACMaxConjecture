...
/-!
# Per-hub good-`C₄` share bound for the `n = 19`, `P₄`-cherry `|D| ∈ {9, 10}` hub-triangle corner
...
theorem nonadj_deg4_hubs_share_le_one_iso_pointwise (G : SimpleGraph (Fin 19))
    (D Iso : Finset (Fin 19))
    ...
    (h₁ h₂ : Fin 19) (h1Dc : h₁ ∈ Dᶜ) (h2Dc : h₂ ∈ Dᶜ)
