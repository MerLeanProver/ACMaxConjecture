...
/-! # The `Z`-slot skeleton for the deg-5 corner (`n = 19`): |Z| = 2, the M-edge, one slot per hub -/
namespace ACMax
...
theorem zslot_skeleton_deg5_nineteen (G : SimpleGraph (Fin 19)) (Hub Iso : Finset (Fin 19))
