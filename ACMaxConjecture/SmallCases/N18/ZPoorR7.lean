...
theorem private_twin_card_eighteen (G : SimpleGraph (Fin 18)) (Iso : Finset (Fin 18))
    (w1 w2 : Fin 18) :
...
theorem iso_deg_four_nonadj_hub_eighteen (G : SimpleGraph (Fin 18)) (Hub Iso : Finset (Fin 18))
    (hdisj : Disjoint Hub Iso) (hdeg4 : ∀ h ∈ Hub, G.degree h = 4)
    (w1 w2 : Fin 18) (hw1 : w1 ∈ Hub) (hw2 : w2 ∈ Hub)
...
theorem two_nonadj_hubs_contra_eighteen (G : SimpleGraph (Fin 18)) (Hub Iso : Finset (Fin 18))
    ...
    (hno2hub : ¬∃ h₁ h₂ : Fin 18, h₁ ∈ Hub ∧ h₂ ∈ Hub ∧
      ...
      2 ≤ ((G.neighborFinset h₂ ∩ Iso) \ G.neighborFinset h₁).card)
    (w1 w2 : Fin 18) (hw1 : w1 ∈ Hub) (hw2 : w2 ∈ Hub) (hw12 : w1 ≠ w2)
    (hnadj : ¬G.Adj w1 w2)
  ...
  have hp1 := private_twin_card_eighteen G Iso w1 w2
  have hp2 := private_twin_card_eighteen G Iso w2 w1
...
theorem two_high_hubs_sum_ge_seven_contra_eighteen (G : SimpleGraph (Fin 18))
    (Hub Iso : Finset (Fin 18)) (hdisj : Disjoint Hub Iso) (hdeg4 : ∀ h ∈ Hub, G.degree h = 4)
    (hshare : ∀ h₁ ∈ Hub, G.degree h₁ = 4 → ∀ h₂ ∈ Hub, G.degree h₂ = 4 → h₁ ≠ h₂ →
      ¬G.Adj h₁ h₂ → (G.neighborFinset h₁ ∩ G.neighborFinset h₂ ∩ Iso).card ≤ 1)
    (hno2hub : ¬∃ h₁ h₂ : Fin 18, h₁ ∈ Hub ∧ h₂ ∈ Hub ∧
      G.degree h₁ = 4 ∧ G.degree h₂ = 4 ∧ h₁ ≠ h₂ ∧ ¬G.Adj h₁ h₂ ∧
  ...
  · have hnadj := iso_deg_four_nonadj_hub_eighteen G Hub Iso hdisj hdeg4 w1 w2 hw1 hw2 h1is4
    exact two_nonadj_hubs_contra_eighteen G Hub Iso hdeg4 hshare hno2hub w1 w2 hw1 hw2 hw12
      hnadj h1ge h2ge
  · have h2is4 : (G.neighborFinset w2 ∩ Iso).card = 4 := by omega
    have hnadj := iso_deg_four_nonadj_hub_eighteen G Hub Iso hdisj hdeg4 w2 w1 hw2 hw1 h2is4
    exact two_nonadj_hubs_contra_eighteen G Hub Iso hdeg4 hshare hno2hub w2 w1 hw2 hw1
      (Ne.symm hw12) hnadj h2ge h1ge

/-- **The verified `C₄` kill `g₁ – g₃ – z' – z`.**  Given the forced two-poor `z`-layout — the poor
triangle edge `g₁ ~ g₃`, the `M`-partner adjacencies `g₃ ~ z'`, `z' ~ z`, `z ~ g₁`, and the two
diagonals `g₁ ≁ z'`, `g₃ ≁ z` — the four-cycle on `{g₁, g₃, z', z}` has degree sum
`4 + 4 + 3 + 3 = 14`, a good `C₄` excluded by `hC4`.  This is the assembled contradiction at the end
of the saturation route; it isolates the kill from the (harder) forcing of its structural
hypotheses. -/
theorem low_rich_c4_assemble_eighteen (G : SimpleGraph (Fin 18))
    (g1 g3 zp z : Fin 18)
    (hdg1 : G.degree g1 = 4) (hdg3 : G.degree g3 = 4)
    (hdzp : G.degree zp = 3) (hdz : G.degree z = 3)
    (hcard : ({g1, g3, zp, z} : Finset (Fin 18)).card = 4)
    (e1 : G.Adj g1 g3) (e2 : G.Adj g3 zp) (e3 : G.Adj zp z) (e4 : G.Adj z g1)
    (d1 : ¬G.Adj g1 zp) (d2 : ¬G.Adj g3 z)
    (hC4 : ¬∃ a b c d : Fin 18, ({a, b, c, d} : Finset (Fin 18)).card = 4 ∧
      G.Adj a b ∧ G.Adj b c ∧ G.Adj c d ∧ G.Adj d a ∧ ¬G.Adj a c ∧ ¬G.Adj b d ∧
      G.degree a + G.degree b + G.degree c + G.degree d ≤ 14) :
    False :=
  hC4 ⟨g1, g3, zp, z, hcard, e1, e2, e3, e4, d1, d2, by rw [hdg1, hdg3, hdzp, hdz]⟩
